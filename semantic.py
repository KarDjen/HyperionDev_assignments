...
# NOTE: I find it interesting that it finds 0.6 similarity between two words
# that represent animals while semantically different (i.e. 'cat' and 'monkey).
# I also note that it the similarity is different between 'banana'/'monkey' and
# 'banana'/'cat' while semantically different.
...
nlp2 = spacy.load('en_core_web_sm') # specifying the model we want to use.
...
# NOTE: we notice a higher degree of accuracy within the md model than the sm model.